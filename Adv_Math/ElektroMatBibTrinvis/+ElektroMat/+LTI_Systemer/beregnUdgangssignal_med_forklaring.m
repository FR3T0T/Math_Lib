function [y, forklaringsOutput] = beregnUdgangssignal_med_forklaring(H_s, X_s, s, t)
    ...
    % Start forklaring
    forklaringsOutput = ElektroMatBibTrinvis.startForklaring('Beregning af udgangssignal');
    ...
    for i = 2:length(inv_forklaring.trin)
        forklaringsOutput = ElektroMatBibTrinvis.tilfoejTrin(forklaringsOutput, i+3, ...
